...
@Component({
  selector: 'app-dossier-update-client',
  templateUrl: './dossier-update-client.component.html',
  styleUrls: ['./dossier-update-client.component.css']
})
export class DossierUpdateClientComponent implements OnInit {
  ...
  ClientId: number;
    ...
    ngOnInit(): void {
      this.ClientId= Number(localStorage.getItem('id'));
       console.log('ID de  CLient  :', this. ClientId);
    ...
    CreateUpdateDossier() {
      this.dossierUpdate.rendezVous.avocat = { id: this.ClientId};
