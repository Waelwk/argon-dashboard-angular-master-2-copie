...
@Component({
  selector: 'app-liste-avocat-cabinet-a',
  templateUrl: './liste-avocat-cabinet-a.component.html',
  styleUrls: ['./liste-avocat-cabinet-a.component.css']
})
export class ListeAvocatCabinetAComponent implements OnInit {
