...
@Component({
  selector: 'app-liste-assistatn-cabinet',
  templateUrl: './liste-assistatn-cabinet.component.html',
  styleUrls: ['./liste-assistatn-cabinet.component.css']
})
export class ListeAssistatnCabinetComponent implements OnInit {
Assistant: Assistant[] = [];
  newAssistant: any = {
    firstname: '',
    lastname: '',
