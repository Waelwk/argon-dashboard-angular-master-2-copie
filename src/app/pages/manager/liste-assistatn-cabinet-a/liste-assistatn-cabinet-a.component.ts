...
@Component({
  selector: 'app-liste-assistatn-cabinet-a',
  templateUrl: './liste-assistatn-cabinet-a.component.html',
  styleUrls: ['./liste-assistatn-cabinet-a.component.css']
})
export class ListeAssistatnCabinetAComponent implements OnInit {
Assistant: Assistant[] = [];
  newAssistant: any = {
    firstname: '',
    lastname: '',
