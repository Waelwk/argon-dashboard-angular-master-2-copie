...
@Component({
  selector: 'app-dossier-archiver',
  templateUrl: './dossier-archiver.component.html',
  styleUrls: ['./dossier-archiver.component.css']
})
export class DossierArchiverComponent {
...
getAllDossiers(): void {
  this.dossierService.getAllDossiers().subscribe(
    (data) => {
      ...
      this.dossierC = this.dossiers.filter(d => d.statut === 'Clôturé');
